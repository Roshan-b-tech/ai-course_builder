...
const ChapterTopicList = ({ course }) => {
    ...
    return (
        <div>
            ...
            <div className='flex flex-col items-center juastify-center mt-10'>
                {courseLayout?.chapters?.map((chapter, index) => (
                    <div key={index} className='flex flex-col items-center'>
                        ...
                        {Array.isArray(chapter?.topic) && chapter.topic.map((topic, index) => (
                            <div className='flex flex-col items-center' key={index}>
                                ...
                                {index === chapter.topic.length - 1 && <div className='h-10 bg-gray-300 w-1'></div>}
